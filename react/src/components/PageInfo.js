      ...
      <Row bsClass="row row-info">
        <Col md={6}>
          ...
          <p>
            ...
            <iframe src="https://ghbtns.com/github-btn.html?user=eduardinni&repo=bootlint-online&type=watch&count=true"
              allowTransparency="true" frameBorder="0" scrolling="0" width="115" height="20"></iframe>
          </p>
        </Col>
        <Col md={6}>
          <h4>Caveats</h4>
          <p>Bootlint assumes that your webpage is already valid HTML5. Use another tool, such as the <a href="https://validator.w3.org/">W3C validator</a>, to check that first. </p>
